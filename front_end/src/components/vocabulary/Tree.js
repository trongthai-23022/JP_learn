...
import "../../pages/MyWord/MyWord.css";
...
const Tree = ({handleCloseModal,handleSave}) => {
    ...
    const handleLessonClick = (lesson) => {
        // Lưu từ vựng hiện tại vào Lesson này
    ...
    return (
        ...
        <div className="my-word__container">
                            ...
                            {selectedFolder.lessons.length > 0 ? (
                                selectedFolder.lessons.map((lesson, index) => (
                                    <Card
                                        ...
                                        sx={{
                                            cursor: "pointer", position: "relative", marginBottom: "10px",
                                            color: lesson === selectedLesson ? 'red' : '#4f4f4f',
                                            backgroundColor: lesson === selectedLesson ? 'lightyellow' : 'white',
                                        }}
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                <Button variant="contained" color="primary" onClick={handleSaveVoca}>
                    Lưu
                </Button>
                <Box sx={{ ml: 1 }}>
